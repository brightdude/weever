...
@interface WEIntroView ()<UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
...
- (void) setup
{
    ...
    [self.collectionView registerClass:[WEIntroPageCell class] forCellWithReuseIdentifier:@"cellIdentifier"];
...
{
    WEIntroPageCell *cell = (WEIntroPageCell *)[collectionView dequeueReusableCellWithReuseIdentifier:@"cellIdentifier" forIndexPath:indexPath];
