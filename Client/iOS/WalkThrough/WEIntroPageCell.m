...
@implementation WEIntroPageCell
...
{
    _title = title;
    [self.titleLabel setFont:[UIFont fontWithName:[UIFont pmTitleTextFont] size:18.0f]];
...
{
    _desc = desc;
    [self.descLabel setFont:[UIFont fontWithName:[UIFont pmTextFont] size:14.0f]];
